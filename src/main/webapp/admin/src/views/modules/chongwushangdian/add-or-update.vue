          ...
          <el-form-item class="input" label="商店地址" prop="shangdiandizhi">
              <el-input v-model="ruleForm.shangdiandizhi" 
                placeholder="商店地址" readonly></el-input>
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="商店介绍" prop="shangdianjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shangdianjieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shangdianjieshao" label="商店介绍" prop="shangdianjieshao">
                    <span v-html="ruleForm.shangdianjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangdiandizhi = true;
            continue;
	            	            ...
	            	            if(o=='shangdianjieshao'){
            this.ruleForm.shangdianjieshao = obj[o];
	    this.ro.shangdianjieshao = true;
            continue;
          }
	                    }
                                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chongwushangdian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chongwushangdianCrossAddOrUpdateFlag = false;
                  this.parent.search();
