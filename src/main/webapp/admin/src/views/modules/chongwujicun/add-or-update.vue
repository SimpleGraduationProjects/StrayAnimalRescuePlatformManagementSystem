<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="寄存标题" prop="jicunbiaoti">
          <el-input v-model="ruleForm.jicunbiaoti" 
              placeholder="寄存标题" clearable  :readonly="ro.jicunbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="寄存标题" prop="jicunbiaoti">
              <el-input v-model="ruleForm.jicunbiaoti" 
                placeholder="寄存标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="寄存日期" prop="jicunriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jicunriqi" 
                type="date"
                placeholder="寄存日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jicunriqi" label="寄存日期" prop="jicunriqi">
              <el-input v-model="ruleForm.jicunriqi" 
                placeholder="寄存日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                                                                                                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="寄存内容" prop="jicunneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jicunneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jicunneirong" label="寄存内容" prop="jicunneirong">
                    <span v-html="ruleForm.jicunneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                	        ...
                	        jicunbiaoti: '',
	                        	        ...
	                        	        shouji: '',
                                              ...
                                              xingbieOptions: [],
                                                                                                                                                                              rules: {
                  jicunbiaoti: [
                            { required: true, message: '寄存标题不能为空', trigger: 'blur' },
                                    	                                                              ],
                  chongwumingcheng: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='jicunbiaoti'){
            this.ruleForm.jicunbiaoti = obj[o];
	    this.ro.jicunbiaoti = true;
            continue;
          }
	    ...
	    this.ro.nianling = true;
            continue;
	            	            ...
	            	            if(o=='jicunneirong'){
            this.ruleForm.jicunneirong = obj[o];
	    this.ro.jicunneirong = true;
            continue;
          }
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='jicunriqi'){
            this.ruleForm.jicunriqi = obj[o];
	    this.ro.jicunriqi = true;
            continue;
          }
	            	            if(o=='beizhu'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chongwujicun/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chongwujicunCrossAddOrUpdateFlag = false;
                  this.parent.search();
