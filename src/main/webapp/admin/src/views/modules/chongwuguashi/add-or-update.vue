<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="挂失标题" prop="guashibiaoti">
          <el-input v-model="ruleForm.guashibiaoti" 
              placeholder="挂失标题" clearable  :readonly="ro.guashibiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="挂失标题" prop="guashibiaoti">
              <el-input v-model="ruleForm.guashibiaoti" 
                placeholder="挂失标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
            ...
            ruleForm: {
                	        guashibiaoti: '',
                                      ...
                                      fenleiOptions: [],
                                                                                                                                                  rules: {
                  guashibiaoti: [
                            { required: true, message: '挂失标题不能为空', trigger: 'blur' },
                                    	                                                              ],
                  fenlei: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='guashibiaoti'){
            this.ruleForm.guashibiaoti = obj[o];
	    this.ro.guashibiaoti = true;
            continue;
          }
	            	            if(o=='fenlei'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chongwuguashi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chongwuguashiCrossAddOrUpdateFlag = false;
                  this.parent.search();
