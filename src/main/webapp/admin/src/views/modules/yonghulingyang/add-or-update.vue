<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="领养标题" prop="lingyangbiaoti">
          <el-input v-model="ruleForm.lingyangbiaoti" 
              placeholder="领养标题" clearable  :readonly="ro.lingyangbiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="领养标题" prop="lingyangbiaoti">
              <el-input v-model="ruleForm.lingyangbiaoti" 
                placeholder="领养标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="分类" prop="fenlei">
              <el-input v-model="ruleForm.fenlei" 
                placeholder="分类" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宠物状态" prop="chongwuzhuangtai">
          <el-input v-model="ruleForm.chongwuzhuangtai" 
              placeholder="宠物状态" clearable  :readonly="ro.chongwuzhuangtai"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" label="年龄" prop="nianling">
              <el-input v-model="ruleForm.nianling" 
                placeholder="年龄" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="领养费用" prop="lingyangfeiyong">
          <el-input v-model="ruleForm.lingyangfeiyong" 
              placeholder="领养费用" clearable  :readonly="ro.lingyangfeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="领养费用" prop="lingyangfeiyong">
              <el-input v-model="ruleForm.lingyangfeiyong" 
                placeholder="领养费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.shenqingriqi" label="申请日期" prop="shenqingriqi">
              <el-input v-model="ruleForm.shenqingriqi" 
                placeholder="申请日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="申请备注" prop="shenqingbeizhu">
          <el-input v-model="ruleForm.shenqingbeizhu" 
              placeholder="申请备注" clearable  :readonly="ro.shenqingbeizhu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="申请备注" prop="shenqingbeizhu">
              <el-input v-model="ruleForm.shenqingbeizhu" 
                placeholder="申请备注" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
                	        ...
                	        lingyangbiaoti: '',
	                        	        ...
	                        	        shouji: '',
	                        	                        	        shhf: '',
                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                              rules: {
                  lingyangbiaoti: [
                            { required: true, message: '领养标题不能为空', trigger: 'blur' },
                                    	                                                              ],
                  chongwumingcheng: [
                                    	                                                              ],
                  fenlei: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='lingyangbiaoti'){
            this.ruleForm.lingyangbiaoti = obj[o];
	    this.ro.lingyangbiaoti = true;
            continue;
          }
	    ...
	    this.ro.nianling = true;
            continue;
	            	            ...
	            	            if(o=='lingyangfeiyong'){
            this.ruleForm.lingyangfeiyong = obj[o];
	    this.ro.lingyangfeiyong = true;
            continue;
          }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yonghulingyang/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yonghulingyangCrossAddOrUpdateFlag = false;
                  this.parent.search();
